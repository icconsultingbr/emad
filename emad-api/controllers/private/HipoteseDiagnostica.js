module.exports = function (app) {
    ...
    const _table = "tb_hipotese_diagnostica";

    app.post('/hipotese-diagnostica', function(req,res){
        let obj = req.body;
    ...
    app.put('/hipotese-diagnostica', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/hipotese-diagnostica/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/hipotese-diagnostica/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
