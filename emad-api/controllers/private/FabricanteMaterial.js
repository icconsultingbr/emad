module.exports = function (app) {
    ...
    app.post('/fabricante-material', function(req,res){
        ...
        req.assert("fabricante").notEmpty().withMessage("O campo Fabricante é um campo obrigatório");
        req.assert("fabricante").isLength({ min: 0, max: 40 }).withMessage("O campo Fabricante deve ter no máximo 40 caractere(s)");
