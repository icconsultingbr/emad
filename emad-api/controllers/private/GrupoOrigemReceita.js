module.exports = function (app) {
    ...
    const _table = "tb_grupo_origem_receita";

    app.post('/grupo-origem-receita', function(req,res){
        let obj = req.body;
    ...
    app.put('/grupo-origem-receita', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/grupo-origem-receita', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/grupo-origem-receita/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/grupo-origem-receita/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
