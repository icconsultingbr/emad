module.exports = function (app) {
    ...
    const _table = "tb_sub_grupo_origem_receita";

    app.post('/sub-grupo-origem-receita', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];

        req.assert("idGrupoOrigemReceita").notEmpty().withMessage("O campo Grupo origem da receita é um campo obrigatório");
    ...
    app.put('/sub-grupo-origem-receita', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/sub-grupo-origem-receita', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/sub-grupo-origem-receita/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/sub-grupo-origem-receita/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
    ...
    function lista(res) {
        ...
        let objDAO = new app.dao.SubGrupoOrigemReceitaDAO(connection);
