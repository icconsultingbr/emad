module.exports = function (app) {
    ...
    const _table = "tb_atencao_continuada";

    app.post('/atencao-continuada', function(req,res){
        let obj = req.body;
    ...
    app.put('/atencao-continuada', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/atencao-continuada', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/atencao-continuada/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/atencao-continuada/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
