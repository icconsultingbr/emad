module.exports = function (app) {
    ...
    const _table = "tb_escolaridade";

    app.post('/escolaridade', function(req,res){
        let obj = req.body;
    ...
    app.put('/escolaridade', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/escolaridade', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/escolaridade/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/escolaridade/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
