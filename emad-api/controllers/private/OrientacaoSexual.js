module.exports = function (app) {
    ...
    const _table = "tb_orientacao_sexual";

    app.post('/orientacao-sexual', function (req, res) {
        let obj = req.body;
    ...
    app.put('/orientacao-sexual', function (req, res) {
        let obj = req.body;
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/orientacao-sexual', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/orientacao-sexual/:id', function (req, res) {
        let usuario = req.usuario;
    ...
    app.delete('/orientacao-sexual/:id', function (req, res) {
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
