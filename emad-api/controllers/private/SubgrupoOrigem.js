module.exports = function (app) {
    ...
    const _table = "tb_subgrupo_origem";

    app.post('/subgrupo-origem', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];

        req.assert("idGrupoOrigem").notEmpty().withMessage("O campo Grupo de origem é um campo obrigatório");
    ...
    app.put('/subgrupo-origem', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/subgrupo-origem', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/subgrupo-origem/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/subgrupo-origem/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
    ...
    function lista(res) {
        ...
        let objDAO = new app.dao.SubgrupoOrigemDAO(connection);
