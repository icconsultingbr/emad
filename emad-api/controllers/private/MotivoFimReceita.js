module.exports = function (app) {
    ...
    app.post('/motivo-fim-receita', function(req,res){
        let obj = req.body;
    ...
    app.put('/motivo-fim-receita', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/motivo-fim-receita', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/motivo-fim-receita/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/motivo-fim-receita/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
