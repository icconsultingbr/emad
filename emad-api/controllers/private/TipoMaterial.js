module.exports = function (app) {
    ...
    const _table = "tb_tipo_material";

    app.post('/tipo-material', function(req,res){
        let obj = req.body;
    ...
    app.put('/tipo-material', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/tipo-material', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/tipo-material/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/tipo-material/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
