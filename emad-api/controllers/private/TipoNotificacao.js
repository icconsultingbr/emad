module.exports = function (app) {
    ...
    const _table = "tb_tipo_notificacao";

    app.post('/tipo-notificacao', function(req,res){
        let obj = req.body;
    ...
    app.put('/tipo-notificacao', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/tipo-notificacao', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/tipo-notificacao/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/tipo-notificacao/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
