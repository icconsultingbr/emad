module.exports = function (app) {
    ...
    const _table = "tb_classificacao_risco";

    app.post('/classificacao-risco', function(req,res){
        let obj = req.body;
        ...
        req.assert("idCorClassificacaoRisco").notEmpty().withMessage("O campo Cor é um campo obrigatório");
        req.assert("peso").notEmpty().withMessage("O campo Peso é um campo obrigatório");
    ...
    app.put('/classificacao-risco', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/classificacao-risco', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/classificacao-risco/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/classificacao-risco/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
    ...
    function lista(res) {
        ...
        let objDAO = new app.dao.ClassificacaoRiscoDAO(connection, _table);
