module.exports = function (app) {
    ...
    const _table = "tb_cor_classificacao_risco";

    app.post('/cor-classificacao-risco', function(req,res){
        let obj = req.body;
    ...
    app.put('/cor-classificacao-risco', function(req,res){
        let obj = req.body;
        let usuario = req.usuario; 
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/cor-classificacao-risco', function (req, res) {
        let usuario = req.usuario;
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/cor-classificacao-risco/:id', function(req,res){        
        let usuario = req.usuario;
    ...
    app.delete('/cor-classificacao-risco/:id', function(req,res){     
        let util = new app.util.Util();
        let usuario = req.usuario;
        let errors = [];
        let id = req.params.id;
