module.exports = function (app) {
    ...
    const _table = "tb_tipo_fornecimento_odonto_atendimento";

    app.post('/tipo-odonto-atendimento', function (req, res) {
        let obj = req.body;
    ...
    app.get('/tipo-odonto-atendimento/:id', function (req, res) {
    ...
    app.delete('/tipo-odonto-atendimento/:id', function (req, res) {
        let id = req.params.id;
        let obj = {};
        obj.id = id;
    ...
    app.put('/tipo-odonto-atendimento', function (req, res) {
        let obj = req.body;
        let errors = [];
        let id = obj.id;
    ...
    function buscarPorAtendimentoId(id, res) {
        ...
        let objDAO = new app.dao.AtendimentoTipoFornecimentoOdontoDAO(connection, _table);
        let errors = [];
    ...
    function atualizaPorId(obj, id, res) {
        ...
        var objDAO = new app.dao.AtendimentoTipoFornecimentoOdontoDAO(connection);
        var errors = [];
