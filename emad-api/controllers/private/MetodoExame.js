module.exports = function (app) {
    app.post('/metodo-exame', async function(req,res){
        let obj = req.body;
        ...
        const repository = new app.dao.MetodoExameDAO(connection);
    ...
    app.put('/metodo-exame', async function(req,res){
    ...
    app.get('/metodo-exame', async function (req, res) {        
        let util = new app.util.Util();
        let errors = [];
    ...
    app.get('/metodo-exame/:id', async function(req,res){        
    ...
    app.delete('/metodo-exame/:id', async function(req,res){
        let util = new app.util.Util();
        let id = req.params.id;      
        let usuario = req.usuario; 
        let errors = [];
