...
export class AtribuicaoCanetaFormComponent implements OnInit {
  ...
  findHistoricoAtribuicoesPorProfissional(dateInicialFormatada, dateFinalFormatada) {
    this.message = "";
    this.errors = [];
    this.loading = true;
    this.service.findHistoricoAtribuicaoByProfissional(this.object.idProfissional, dateInicialFormatada, dateFinalFormatada).subscribe(result => {
  ...
  carregarCanetasDisponiveis() {
    ...
    {     
        ...
        this.findHistoricoAtribuicoesPorProfissional(dateInicialFormatada, dateFinalFormatada);
