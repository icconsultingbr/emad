...
export class AtribuicaoCanetaFormComponent implements OnInit {
  ...
  carregarHorarios() {
    ...
    const teste = this.horarios.dataAtribuicao;

    if (!Util.isEmpty(this.horarios.dataAtribuicao)) {
      const ano = new Date(this.horarios.dataAtribuicao).getFullYear();
      const mes = (new Date(this.horarios.dataAtribuicao).getMonth() + 1).toString();
      const anoMes = ano + mes.padStart(2, '0');

      const diaSemana = new Date(this.horarios.dataAtribuicao).getDay();
  ...
  carregarCanetasDisponiveis() {
    ...
    if (!Util.isEmpty(this.horarios.horarioInicial) && !Util.isEmpty(this.horarios.horarioFinal) && !Util.isEmpty(this.horarios.dataAtribuicao)) {
        const periodoinicial = new Date(this.horarios.dataAtribuicao.getFullYear(),
        ...
        const periodofinal = new Date(this.horarios.dataAtribuicao.getFullYear(),
                               this.horarios.dataAtribuicao.getMonth(),
                               this.horarios.dataAtribuicao.getDate(),
        ...
        const dataAtribuicao = periodoinicial.getFullYear() + '-' + this.twoDigits(1 + periodoinicial.getMonth()) + '-' + this.twoDigits(periodoinicial.getDate());
      ...
      const dataAtribuicao = this.horarios.dataAtribuicao.getFullYear() + '-' + this.twoDigits(1 + this.horarios.dataAtribuicao.getMonth()) + '-' + this.twoDigits(this.horarios.dataAtribuicao.getDate());
