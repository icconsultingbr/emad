...
import { MedicamentoAjusteEstoqueService } from '../../farmacia/relatorios/medicamento-ajuste-estoque/medicamento-ajuste-estoque.service';

@Injectable()
export class MedicamentoAjusteEstoqueImpressaoService extends RelatorioMedicamentoService {
    constructor(private medicamentoAjusteEstoqueService: MedicamentoAjusteEstoqueService) {
        super();
    ...
    imprimir(object: any, nomeEstabelecimento: string, criteriosPesquisa: any, target: string = '_blank') {
        ...
        this.medicamentoAjusteEstoqueService.carregaMovimentoAjusteEstoque(object.idTipoMovimento, object.params)
        .subscribe((unidades) => {
