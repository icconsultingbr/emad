...
import { MedicamentoMovimentoComponent } from "./medicamento-movimento.component";
import { medicamentoMovimentoRoutes } from "./medicamento-movimento.routing";
...
@NgModule({
    imports: [
        ...
        AppGridViewModule,
        AppFormModule,
        RouterModule.forChild(medicamentoMovimentoRoutes),
        ReactiveFormsModule,
        FormsModule,
        ReactiveFormsModule,        
        NgbModule,
    ...
    declarations: [
        MedicamentoMovimentoComponent,
    ],
    providers: [
        MedicamentoMovimentoService   
    ]
})
export class MedicamentoMovimentoModule {
}